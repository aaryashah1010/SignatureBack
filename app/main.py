...
from app.presentation.routers import annotate, audit_report, auth, documents, users
...
# Audit report: POST /api/documents/audit-page  (appends the Final Audit Report page)
app.include_router(audit_report.router, prefix=settings.api_prefix)
